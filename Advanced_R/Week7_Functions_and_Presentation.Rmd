...
Create a function that extracts and plots multiple spatial datasets over a time series. Turn this time series into a gif.

Extra Credit!!

Turn the above into an RMarkdown instance.