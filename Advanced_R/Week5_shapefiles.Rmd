...
# Since they don't play nicely, we'll need to convert our original merged.coast to a Simple Feature
...
Using the **ne_10m_parks_and_protected_lands** dataset, map the names of the protected lands in the Pacific Northwest using the following methods. 
...
4) mapview
    ...
    - Note that you don't have to fuse a csv and this shapefile together. 
