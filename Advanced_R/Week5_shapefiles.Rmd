...
1) spplot **with statelines and new color scheme**
2) tmap **with statelines and new color scheme**
3) ggplot2 **with legend containing only protected lands in the Pacific NW**
4) mapview **with new color scheme**

Submit resulting plots and code as "ec_**plottype**.png" with the above assignment