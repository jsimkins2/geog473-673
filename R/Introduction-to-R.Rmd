...
```{r, echo=FALSE, out.width="70%", fig.align="center"}
knitr::include_graphics("images/tree_basic_plots.png")  
```
...
```{r, echo=FALSE, out.width="60%", fig.align="center"}
knitr::include_graphics("images/denali.png")  
```
...
```{r, echo=FALSE, out.width="60%", fig.align="center"}
knitr::include_graphics("images/delmaxpred.png")  
```
...
Using the **ne_10m_parks_and_protected_lands** shapefile dataset, map the names of the protected lands (variable is `name`) in the **Pacific Northwest** using the methods listed below. You will need to download all of the contents of the **ne_10m_parks_and_protected_lands** shapefile folder. Below, a bounding lat/lon box of -127 W, -110 E, 40 S, 50 N was used for `tmap` plot and `ggplot` plot. You may use a bounding box of your choice where you see fit. Submit your plots to UD Canvas.
...
```{r, echo=FALSE, out.width="60%", fig.align="center"}
knitr::include_graphics("images/denali_out.png")  
```
...
knitr::include_graphics("images/basin_goesSST.png")
```
