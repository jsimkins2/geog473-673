...
``` {r, echo = FALSE, message = FALSE, error = FALSE, warning = FALSE, fig.height=10, fig.width=16}
library(basicPlotteR)
library(ncdf4)
library(raster)
library(rgdal)
# load the data using read.csv()
trees = nc_open("/Users/james/Documents/Github/geog473-673/datasets/treecov.nc")
...
world.shp <- readOGR("/Users/james/Documents/Github/geog473-673/datasets/world_shpfiles/world.shp")
