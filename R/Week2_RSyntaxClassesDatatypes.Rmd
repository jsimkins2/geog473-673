...
```{r, echo=FALSE}
knitr::include_graphics("https://github.com/jsimkins2/geog473-673/tree/master/R/Week2_RSyntaxClassesDatatypes_files/figure-markdown_github/Week2_dqf_plot.png")
```
